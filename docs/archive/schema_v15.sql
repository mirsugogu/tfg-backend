-- ============================================================
-- Optima SaaS - Database Schema v15
...
-- ------------------------------------------------------------
-- [v15 bloqueos] 13. SCHEDULE BLOCKS (bloqueos de agenda por dia completo)
...
-- (mismo password "12345678", mismo hash BCrypt; el salt va embebido en el hash)
INSERT INTO users (id_business, id_role, full_name, email, password_hash)
...
INSERT INTO appointments (id_business, id_client, id_employee, id_booth, id_status, is_paid,
...
-- ------------------------------------------------------------
INSERT INTO schedule_blocks (id_business, id_employee, id_booth, start_date, end_date, reason)
