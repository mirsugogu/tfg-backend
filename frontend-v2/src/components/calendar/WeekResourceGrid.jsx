// Vista semanal de la agenda con subcolumnas por recurso y dia
...
export function WeekResourceGrid({
  ...
  // Omite la columna sin asignar cuando no hay citas huerfanas
  ...
  // "Sin asignar" aparece solo si hay citas huerfanas o si no hay recursos configurados
  const cols = [
    ...resources,
  ...
  // Ancho base por columna de recurso
