    ...
    <div className="px-4 sm:px-6 lg:px-8 xl:px-10 py-8">
      ...
      {drawer && (
        <>
          ...
          />
          <aside
            className="fixed top-0 right-0 z-50 h-screen w-[420px] max-w-[95vw] bg-white shadow-[0_28px_56px_-16px_rgba(15,23,42,0.22)] flex flex-col animate-[slideInRight_240ms_cubic-bezier(0.2,0.7,0.2,1)]"
          >
